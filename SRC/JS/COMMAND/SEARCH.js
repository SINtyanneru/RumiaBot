...
export class SEARCH {
	...
	async main() {
		...
		const OPTION = {
			...
			path: "/customsearch/v1" + "?key=" + encodeURIComponent(CONFIG.GOOGLE_SEARCH.GOOGLE_API_KEY) + "&cx=" + encodeURIComponent(CONFIG.GOOGLE_SEARCH.GOOGLE_API_ENGINE_ID) + "&q=" + encodeURIComponent(this.SEARCH_WORD),
			method: "GET"
		};
